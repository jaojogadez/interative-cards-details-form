...
const inputCVC = document.getElementById("cardholder-cvc"); // Input CVC7
...
const checkNumberCard = document.querySelector(
  "#numberCardField .bi-check2-circle"
);
...
inputNumberCard.addEventListener("input", () => {
  ...
  const formatNumberCard = valueNumberCard
    .replace(regexNumberCard, "$1 ")
    .slice(0, 19); // formata o valor do input para add espaços
